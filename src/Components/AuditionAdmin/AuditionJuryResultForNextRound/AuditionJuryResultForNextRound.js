...
import "./AuditionJuryResultForNextRound.css";

const AuditionJuryResultForNextRound = () => {
          ...
          {showHide ? (
            <div className="row">
              ...
              <div className="col-md-4 my-4">
                <div className="col-md-4">
                  <button className="btn viewList fw-bold w-100">
                    View List
                  </button>
                </div>
              </div>
              ...
              <div className="bg-dark">
                <div className="p-2 rounded-3">
                  <h5 className="text-white p-1 mx-2">
...
export default AuditionJuryResultForNextRound;
