...
import small from "../../../../../../../src/assets/images/Souvenir/small.png";
import Slider from "react-slick";

import CricketJerseyModal2 from "./CricketJerseyModal2";
const CricketJerserAdmin3 = () => {
  ...
  return (
    ...
    <div className="row">
          <div className="col-md-2 d-flex justify-content-center align-items-center">
            ...
            <h5 className="text-light"><img src={small} className="img-fluid mx-1" alt="" />Sha shufi</h5>
          </div>
          <div className="col-md-2 d-flex justify-content-center align-items-center">
           <h5 className="text-light">$150</h5>
          </div>
          <div className="col-md-2 d-flex justify-content-center align-items-center" >
          <h5 className="text-light">12-12-2021</h5>
          </div>
          <div className="col-md-2 d-flex justify-content-center align-items-center">
          <h5 className="text-light">11.50 pm</h5>
          </div>
          <div className="col-md-2 d-flex justify-content-center align-items-center">
          <h5 className="text-light">Pending</h5>
          </div>
          <div className="col-md-2 d-flex justify-content-center align-items-center" >
...
export default CricketJerserAdmin3;
