...
// const percentage = 66;
const ScheduleLearnView = () => {

    return (
        <div className='container-fluid my-2'>
            <div className="d-flex justify-content-between">
                <h5 className='text-light'>Schedules</h5>
                <Link to='/superstar-admin/learning-session/schedule'> <div className="btn btn-warning px-4 py-1"><span className='fw-bold'>+</span> New Schedule</div></Link>
            </div>
                        ...
                        <div className="col-md-4" style={{ borderLeft: "1px dashed yellow" }}>
                            ...
                            <div>
                                ...
                                <div className="p-5 text-center">
                                    ...
                                    <Link to='/superstar-admin/live-chat/learning-session/event-create'>
...
export default ScheduleLearnView;
