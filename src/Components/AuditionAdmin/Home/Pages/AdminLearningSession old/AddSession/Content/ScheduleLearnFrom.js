                            ...
                            <div className="card-body container-fluid">
                                ...
                                <div className="my-3 row">
                                    ...
                                    <div className="col-sm-8 d-flex">
                                        ...
                                        <Link to='/superstar-admin/learning-session/schedule-view'><button className="btn btn-warning px-4 ">Save</button></Link>
...
export default ScheduleLearnFrom;
