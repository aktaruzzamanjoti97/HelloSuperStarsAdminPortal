...
import ApprovedLearnSlide from './ApprovedLearnSlide'
  ...
  return (
    ...
    <div className="AS">
        ...
        <div className="liveMeetupBorder my-5">
            ...
            <center><Link to='/superstar/learning-session/approved-all'><Button className='btn bg-warning mt-3 mb-3 fw-bold text-dark ' > View All</Button></Link></center>
