...
<nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    ...
    <div className="nav">
      ...
      <Collapse in={open}>
        <div id="example-collapse-text">
          <Link className="nav-link" to="/superstar-admin/audition/dashboard">
          <div className="sb-nav-link-icon">
          ...
          <Link className="Link text-light" to="/superstar-admin/audition/certificate-create">
  ...
  <div className="sb-sidenav-footer">
    <div className="p">Logged in as:</div>
