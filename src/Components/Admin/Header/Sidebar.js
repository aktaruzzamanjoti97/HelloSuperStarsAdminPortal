...
<nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div className="sb-sidenav-menu">
        <div className="nav">
            ...
            <div className="nav-link" onClick={()=> setOpen(!open)} aria-controls="example-collapse-text"
                aria-expanded={open} >
                <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>
                Audition
            </div>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item className='marktePlaceOrderTxt'>
                            <Link to='/superstar-admin/souvenir/marketplace-orderlist'> MarketPlace </Link>
                        </Dropdown.Item>
                        <Link to='superstar-admin/souvenir/auction-orderlist'>
                        <Dropdown.Item className="marktePlaceOrderTxt">Auction</Dropdown.Item>
                        </Link>
