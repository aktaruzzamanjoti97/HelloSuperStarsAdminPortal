                                        ...
                                        <div className="col-md-10">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    <select onChange={selectState} className="form-control reply-control input-overlay" id='category_id' name='category_id' value={registerInput.category_id}>
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <select onChange={handleInput} className="form-control reply-control input-overlay" name='subcategory_id' value={registerInput.subcategory_id}>
                                                    <option className="text-whaite" value="">Choose One</option>
