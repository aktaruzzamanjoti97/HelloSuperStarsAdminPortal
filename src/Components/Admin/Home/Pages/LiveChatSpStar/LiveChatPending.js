...
const LiveChatPending = () => {
  ...
  useEffect(() => {
    axios.get(`/api/admin/live_chat/pending`).then((res) => {
      if (res.status === 200) {
                    ...
                    <div className="completedMeetupBlack">
                      ...
                      <div className="p-3">
                        <div className="d-flex justify-content-between">
                          <Link
                            to={`/superstar-admin/pending-livechat/${event.id}`} style={{ textDecoration: 'none' }}
                          >
...
export default LiveChatPending;
