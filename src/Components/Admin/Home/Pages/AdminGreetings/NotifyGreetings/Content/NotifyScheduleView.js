...
// const percentage = 66;
const NotifyScheduleView = () => {

    return (
        <div className='container-fluid my-2'>
            <div className="d-flex justify-content-between">
                <h5 className='text-light'>Schedules</h5>
                <Link to='/superstar-admin/notify-schedule'> <div className="btn btn-warning px-4 py-1"><span className='fw-bold'>+</span> New Schedule</div></Link>
            </div>
                        ...
                        <div className="col-md-4" style={{ borderLeft: "1px dashed yellow" }}>
                            ...
                            <div>
                                ...
                                <div className="p-5 text-center">
                                    ...
                                    <button className="btn bg-warning fw-bold" >Requests List</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
...
export default NotifyScheduleView;
