...
const AdminGreetingsEditForm = (props) => {
        ...
        >
          ...
          <div className="row my-4">
            ...
            <div className="col-md-10">
                ...
                <img src={`http://localhost:8000/${file}`}  className="img-fluid avatar-img-src" alt="profile-pic"/>
...
export default AdminGreetingsEditForm;
