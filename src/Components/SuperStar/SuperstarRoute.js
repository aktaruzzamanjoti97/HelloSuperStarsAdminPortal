...
import EditProductSouvenir from './Pages/Superstar-Souvenir/SuperstarProductList/Auction/EditProductSouvenir';
...
const SuperstarRoute = [
    ...
    { path: '/superstar/souvenir/edit/:id', exact: true, name: 'superstar-souvenir-edit', component: EditProductSouvenir },
    ...
    { path: '/superstar/videocall', exact: true, name: 'superstar-learning-session-live-stream', component: LearningSessionLiveStream },
        ...
        // { path: '/superstar/allPromo/videos', exact: true, name: 'allPromo', component: AllPromoVideos },
