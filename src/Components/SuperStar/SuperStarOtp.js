...
const AdminOTP = () => {
  ...
  useEffect(() => {
    ...
    const musking_num = `${number.substring(0, 3)} ${"****"} ${number.substring(
      6,
      number.length
    )}`;
