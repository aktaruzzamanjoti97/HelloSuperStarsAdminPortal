...
const ApprovedEventSliders = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/star/meetup_event/approved`).then(res =>{
                        ...
                        <div className="completedMeetupBlack">
                            ...
                            <div className="p-3">
                                <div className="d-flex justify-content-between">
                                    <Link to={`/superstar/join-meetup-events/${event.id}`}>
...
export default ApprovedEventSliders;