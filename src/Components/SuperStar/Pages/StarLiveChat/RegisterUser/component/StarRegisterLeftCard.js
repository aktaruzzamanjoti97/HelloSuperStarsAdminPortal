...
export default function StarRegisterLeftCard(props) {
  ...
  useEffect(() => {
    ...
    axios.get(`/api/sinlgeLiveChat/${live_chat_id}`).then(res =>{
        ...
        <div className="card-body">
          ...
          <div className="time-table3 d-flex  my-3">
            ...
            <div className="other mx-1 p-2">
              ...
              <br></br>
              <span className="text-warning date-font">{liveChat.fee} BDT</span>
            </div>
          </div>
        </div>
      </div>
