...
<>
    <div className="col-md-12 ">
        <div className="d-flex pt-3">
            ...
            <h4 className="mx-3 text-warning p-2">Approved Event Learning Session  
        ...
        <div className="row">
            ...
            <div className="col-md-3">
                <Link to='/superstar/learning-session/approved/join' className='LinkEventSchedule'>
...
export default ApprovedLearnEvent;