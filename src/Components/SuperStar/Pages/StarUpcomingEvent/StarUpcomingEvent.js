        ...
        <div className="card-body ">
          ...
          <div className="my-3 row">
            <div className="col-md-6 ">
              <div className="card inside-card">
                <div className="card-body text-center">
                  <img src={calender} alt="" className="img-fluid inside-img" height="70px" width="70px" />
                </div>
                <div className="my-2">
            ...
            <div className="col-md-6 ">
              <div className="card inside-card">
                <div className="card-body text-center">
                  <img src={addNew} alt="" className="img-fluid inside-img" height="70px" width="70px" />
                </div>
                <div className="card-body">
    ...
    <div className="col-md-6 ">
      <div className="card event-live-card">
        <div className="card-body ">
          ...
          <div className=" row ">
            <div className="col-md-6 ">
              <img src={darkImg} alt="" classNae="img-fluid" height="170px" width="90%" />
            </div>
            <div className="col-md-6 ">
              <div className="card" style={{ background: "#2D2D2D", border: "none" }}>
                <div className="card-body">
            ...
            <div className="col-md-3">
              <div className="card inside-card2">
                <div className="learn-container">
                  <img src={SpinLearn} className="img-fluid spinlearn" alt="" />
...
export default StarUpcomingEvent;